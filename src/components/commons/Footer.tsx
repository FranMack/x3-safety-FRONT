...
export const Footer = () => {
  return (
    <footer className="relative z-50 bg-backgroundColor text-black  h-[90vh] md:h-[50vh] text-[1.5rem] ">
      <div className="w-full h-[90%] md:h-[80%] flex items-center  ">
        <div className="w-full h-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="flex flex-col items-center justify-center gap-y-[1vh] text-[1.6rem]  ">
          ...
          <div className="flex flex-col items-center justify-center gap-y-[1vh]">
            ...
            <div className="flex items-start text-[1.6rem]">
          ...
          <div className="flex flex-col items-center justify-center gap-y-[1vh]">
            ...
            <ul className="space-y-2 text-[1.6rem]">
              {links.map((item) => {
                return (
                  <li key={item.path}>
                    <a
